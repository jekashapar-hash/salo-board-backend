...
urlpatterns = [
    ...
    path(
        "tournaments/<int:tournament_id>/leaderboard/<int:team_id>/rank",
        TournamentTeamRankView.as_view(),
        name="tournament-team-rank",
    ),
    path(
    ...
    path(
        "tournaments/<int:tournament_id>/admins",
        TournamentAdminView.as_view(),
        name="tournament-admins",
    ),
    path(
        "tournaments/<int:tournament_id>/jury-evaluations",
        TournamentJuryEvaluationsView.as_view(),
        name="tournament-jury-evaluations",
    ),
    path(
        "tournaments/<int:tournament_id>/jury-evaluations/count",
        TournamentJuryEvaluationsCountView.as_view(),
        name="tournament-jury-evaluations-count",
    ),
    path(
    ...
    path("user/telegram-status", UserTelegramStatusView.as_view(), name="user-telegram-status"),
]
